...
class Imagen(models.Model):
	...
	def create_thumbnail(self):
		...
		# ImageField
		suf = SimpleUploadedFile(os.path.split(self.imagen.name)[-1], temp_handle.read(), content_type='imagen/%s' % (image_type))
...
class CampoTipoInmueble(models.Model):
	...
	class Meta:
		...
		verbose_name_plural = "Campos Inmuebles"
...
class ValorCampoTipoInmueble(models.Model):
	...
	class Meta:
		verbose_name = "Valor Campo"
		verbose_name_plural = "Valor Campos"
